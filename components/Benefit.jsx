...
const Benefit = ({ icon, title, caption, background="bg-slate-900", style }) => {
  ...
  return (
    <section className={`padding-container h-[200px] ${background} relative md:flex flex-wrap`}>
            <Image 
            src={icon}
            width={800}
            height={800}
            className={`absolute bottom-[90px] left-[75%] lg:left-[80%] rotate-[10deg] w-[150px] md:hidden hover:translate-y-[-10px] transition-all ${style}`}
            ></Image>
